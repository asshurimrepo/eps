...
@if(Session::has('err'))
	...
	<div class="alert alert-danger"><i class="icon-warning-sign"></i> {{ Session::get('err') }}
...
@if(Session::has('err2'))
	...
	<div class="alert alert-danger" style="text-transform: initial; font-weight:bold"><i class="icon-warning-sign"></i> {{ Session::get('err2') }}</div>
...
@if(Session::has('suc'))
	...
	<div class="alert alert-success"><i class="icon-ok-sign"></i> {{ Session::get('suc') }}
	<button type="button" class="close" data-dismiss="alert"><i class="icon-remove"></i></button></div>
